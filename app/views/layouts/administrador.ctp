...
<head>
    ...
    <!-- Morris Charts CSS -->
    <link href="/cakephp-1.3.20/css/plugins/morris.css" rel="stylesheet">
...
<body>
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    <li class="active">
                        <a href="index.html"><i class="fa fa-fw fa-dashboard"></i> Publicaciones</a>
                    </li>
                    <li>
    ...
    <script src="/cakephp-1.3.20/js/plugins/morris/raphael.min.js"></script>
    <script src="/cakephp-1.3.20/js/plugins/morris/morris.min.js"></script>
    <script src="/cakephp-1.3.20/js/plugins/morris/morris-data.js"></script>
